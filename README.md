...
with [spring-loaded](https://github.com/spring-projects/spring-loaded), Maven and Java 8 to develop standalone
application with hot-reloading of changes done to classes and resource files during development.
...
1. Open **http://localhost:8080/greeting** in a browser window
